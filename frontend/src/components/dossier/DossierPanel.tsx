  ...
  return (
    <div style={{ marginTop: 12 }}>
      ...
      <div style={{
        ...
        <span style={{ color, fontSize: "calc(16px * var(--font-scale))", fontWeight: 700, fontFamily: 'var(--font-mono)' }}>
          {display}<span style={{ fontSize: "calc(9px * var(--font-scale))", marginLeft: 1 }}>%</span>
        </span>
      </div>
      {/* Track */}
      <div style={{
      ...
      <div style={{
        ...
        fontFamily: 'var(--font-mono)', fontSize: "calc(7px * var(--font-scale))",
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <span style={{
            fontFamily: 'var(--font-heading)', fontSize: "calc(9px * var(--font-scale))", fontWeight: 700,
          ...
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: "calc(9px * var(--font-scale))", color: 'var(--text-muted)' }}>
            ({year})
          </span>
        </div>
        {risk !== 'unknown' && (
          <span style={{
            fontFamily: 'var(--font-mono)', fontSize: "calc(7px * var(--font-scale))", fontWeight: 700,
      ...
      {desc && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, marginTop: 2 }}>
          <div 
            ...
            style={{
              fontFamily: 'var(--font-heading)', fontSize: "calc(8px * var(--font-scale))", color: 'var(--accent-primary)',
          ...
          {expanded && (
            <div style={{
              fontFamily: 'var(--font-mono)', fontSize: "calc(9px * var(--font-scale))", color: 'var(--text-muted)',
              ...
              {samples.length > 0 && (
                <div style={{ marginTop: 6, display: 'flex', flexDirection: 'column', gap: 4 }}>
                  <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(7px * var(--font-scale))", color: 'var(--accent-threat)', letterSpacing: '0.05em', borderBottom: '1px solid rgba(244,63,94,0.2)', paddingBottom: 2 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    {(samples as Array<{ email?: string; ip_address?: string; password?: string; phone?: string }>).map((s, idx: number) => (
                      <div key={idx} style={{
                        ...
                        display: 'flex', flexDirection: 'column', gap: 2, fontFamily: 'var(--font-mono)', fontSize: "calc(8px * var(--font-scale))"
                      }}>
              ...
              <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: 4, display: 'flex', justifyContent: 'space-between', fontSize: "calc(8px * var(--font-scale))" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid var(--struct-line)', paddingBottom: 8 }}>
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(11px * var(--font-scale))", fontWeight: 700, color: '#ff3b30', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
                  BREACH REPORT: {transliterate(selectedBreach.breach || '')}
                </div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: "calc(8px * var(--font-scale))", color: 'var(--text-muted)', marginTop: 2 }}>
                  TARGET EMAIL: {selectedBreach.email || ''}
                </div>
              </div>
              <button
                onClick={() => setSelectedBreach(null)}
                style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: "calc(14px * var(--font-scale))" }}
              >
                ✕
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, background: '#000000', border: '1px solid var(--struct-line)', padding: 10 }}>
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(7px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em' }}>{t('dossier.date_exposure')}</div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: "calc(10px * var(--font-scale))", fontWeight: 650, color: '#ffffff', marginTop: 2 }}>{selectedBreach.xposed_date || ''}</div>
              </div>
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(7px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em' }}>{t('dossier.records_exposed')}</div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: "calc(10px * var(--font-scale))", fontWeight: 650, color: '#ffffff', marginTop: 2 }}>{Number(selectedBreach.exposed_records_count || 0).toLocaleString()}</div>
              </div>
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(7px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em' }}>{t('dossier.associated_domain')}</div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: "calc(10px * var(--font-scale))", fontWeight: 650, color: '#ffffff', marginTop: 2 }}>
              ...
              <div>
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(7px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em' }}>{t('dossier.password_security')}</div>
                <div style={{
                  fontFamily: 'var(--font-mono)', fontSize: "calc(8px * var(--font-scale))", fontWeight: 700,
            ...
            {/* Exposed Fields */}
            <div>
              <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(8px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em', marginBottom: 6 }}>{t('dossier.exposed_classes')}</div>
            ...
            {/* Description */}
            <div>
              <div style={{ fontFamily: 'var(--font-heading)', fontSize: "calc(8px * var(--font-scale))", color: 'var(--text-muted)', letterSpacing: '0.05em', marginBottom: 4 }}>{t('dossier.breach_context')}</div>
              <div style={{
                fontFamily: 'var(--font-mono)', fontSize: "calc(9px * var(--font-scale))", color: 'var(--text-primary)',
