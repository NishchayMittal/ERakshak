...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* Corner HUD brackets */}
      {[['top:16px;left:16px', 'borderTop:1px solid #39ff14;borderLeft:1px solid #39ff14'],
        ['top:16px;right:16px', 'borderTop:1px solid #39ff14;borderRight:1px solid #39ff14'],
        ['bottom:16px;left:16px', 'borderBottom:1px solid #39ff14;borderLeft:1px solid #39ff14'],
        ['bottom:16px;right:16px', 'borderBottom:1px solid #39ff14;borderRight:1px solid #39ff14'],
      ].map(([pos], i) => {
        const borders = [
          { borderTop:'1px solid rgba(57,255,20,0.4)', borderLeft:'1px solid rgba(57,255,20,0.4)' },
          { borderTop:'1px solid rgba(57,255,20,0.4)', borderRight:'1px solid rgba(57,255,20,0.4)' },
          { borderBottom:'1px solid rgba(57,255,20,0.4)', borderLeft:'1px solid rgba(57,255,20,0.4)' },
          { borderBottom:'1px solid rgba(57,255,20,0.4)', borderRight:'1px solid rgba(57,255,20,0.4)' },
        ];
        const posStyles = [
        ...
        <div style={{ padding: '32px 32px 24px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            ...
            <h1 style={{
              ...
              color: '#39ff14', letterSpacing: '0.2em', textTransform: 'uppercase',
          ...
          <div style={{
            ...
            color: '#39ff14', marginBottom: 20, textAlign: 'center',
            opacity: 0.6,
          }}
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(168,85,247,0.85)';
              }}
              onMouseLeave={(e) => {
